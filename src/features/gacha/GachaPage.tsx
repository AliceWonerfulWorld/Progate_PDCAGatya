  ...
  return (
    <div className="space-y-6 text-center">
      <div className="relative isolate overflow-hidden">
        ...
        <section className={`gacha-reveal-card relative space-y-3 border px-4 py-8 ${RARITY_STYLES[result.rarity]}`}>
          ...
          {result.imagePath ? (
            <img alt={result.characterName} className="gacha-reveal-pop mx-auto aspect-square w-40 border border-white/70 object-cover shadow-sm" src={result.imagePath} />
          ) : null}
          {result.wasDuplicate ? (
            <>
