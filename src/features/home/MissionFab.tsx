        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-sm font-medium text-reward-text">
                  今日のミッション
                </p>
                <h2 className="mt-1 text-lg font-bold" id="mission-heading">
                  PDCAを1周する
                </h2>
              </div>
              <button
                aria-label="ミッションを閉じる"
                className="grid size-11 place-items-center rounded-2xl bg-surface-muted text-text-muted transition-colors duration-(--duration-fast) ease-standard active:scale-[0.97]"
