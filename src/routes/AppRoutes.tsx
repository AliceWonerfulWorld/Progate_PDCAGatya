...
const CharacterDetailPage = lazy(() =>
  import("../features/collection/CharacterDetailPage").then((module) => ({
...
const CreateGoalPage = lazy(() =>
  import("../features/goals/CreateGoalPage").then((module) => ({
    default: module.CreateGoalPage,
  })),
);
const GoalDetailPage = lazy(() =>
  import("../features/goals/GoalDetailPage").then((module) => ({
...
const GachaPage = lazy(() =>
  import("../features/gacha/GachaPage").then((module) => ({
...
const HistoryDetailPage = lazy(() =>
  import("../features/history/HistoryDetailPage").then((module) => ({
...
const ActPage = lazy(() =>
  import("../features/pdca/ActPage").then((module) => ({
    default: module.ActPage,
  })),
);
const CheckPage = lazy(() =>
  import("../features/pdca/CheckPage").then((module) => ({
    default: module.CheckPage,
  })),
);
const CompletePage = lazy(() =>
  import("../features/pdca/CompletePage").then((module) => ({
    default: module.CompletePage,
  })),
);
const DoPage = lazy(() =>
  import("../features/pdca/DoPage").then((module) => ({
    default: module.DoPage,
  })),
);
const PlanPage = lazy(() =>
  import("../features/pdca/PlanPage").then((module) => ({
...
const WelcomePage = lazy(() =>
  import("../features/onboarding/WelcomePage").then((module) => ({
